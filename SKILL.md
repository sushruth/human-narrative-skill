...
- **Give the reader something to attach the first fact to.** At the top of a piece nothing is on the table yet, so the opening line puts one thing there: a situation stated plainly in a few words, small enough to recognize at a glance. Recognition raises a question on its own, and the next sentence answers it. Information delivered before that question has nowhere to go. Each section then does the same for the next one: the answer it gives is the question the following section resolves.
