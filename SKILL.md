...
Apply these rules to all output — prose, code comments, commit messages, PR descriptions, docs, explanations. This is one coherent style: plain human narrative, not an AI essay.
...
- **Terse and directive.** Lists and action over elaboration. Skip reverent treatment of conventions; vary register naturally.
